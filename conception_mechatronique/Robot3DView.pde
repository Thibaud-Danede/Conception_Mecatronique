...
float[][] robot3dAssemblyConfig = {
  { 0.000,  0.000,  0.005,   0,  0,   0 }, // J1 : Socle
  { 0.005, -0.102,  0.010,  90,  0,   -29 }, // J2 : Épaule
  { 0.005, -0.085,  0.034, -90,  0,   90 }, // J3 : Bras
  {-0.246, 0.107,  0.031,  -1,  0, -262 }, // J4 : Poignet 1
  { 0.030, -0.230,  0.060,   0,  -88,   0 }, // J5 : Poignet 2
  {-0.017, -0.069,  0.002, -13, 90,  186 }  // J6 : Pince / Effecteur
};
