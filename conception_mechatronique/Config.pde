...
boolean forceSensorAutoNudgeEnabled = false;
float forceSensorAutoNudgeThresholdKg = 0.5;
float forceSensorAutoNudgeDeltaZMm = -1.0;
int forceSensorAutoNudgeCooldownMs = 700;
int forceSensorAutoNudgeValidationTimeoutMs = 1200;
